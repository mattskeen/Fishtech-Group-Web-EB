...
class CP_HubSpot_Contacts extends CP_HubSpot_BaseClient{
    ...
    **/
    public function create_contact($params){
    	...
    	} catch (CP_HubSpot_Exception $e) {
    		throw new CP_HubSpot_Exception('Unable to create contact: ' . $e);
    	}
    }
    ...
    **/
    public function update_contact($vid, $params){
    	...
    	try{
    		...
    		throw new CP_HubSpot_Exception('Unable to update contact: ' . $e);
    	}
    }
